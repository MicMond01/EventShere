import { z } from "zod";
import { CURRENCY_CODES, COUNTRY_CODES } from "@eventshere/shared";
...
export const createVenueSchema = z.object({
  ...
  countryCode: z.enum(COUNTRY_CODES as [string, ...string[]]).default("NG"),
  ...
  currency: z.enum(CURRENCY_CODES as [string, ...string[]]).default("NGN"),
